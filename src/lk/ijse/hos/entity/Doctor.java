...
public class Doctor {
    ...
    public Doctor(String Doctor_ID, String Doctor_Name, String Address, String Specialized_IN, Double Salary) {
        this.Doctor_ID = Doctor_ID;
        this.Doctor_Name = Doctor_Name;
        this.Address = Address;
        this.Specialized_IN = Specialized_IN;
    ...
    public String toString() {
        return "Doctor{" + "Doctor_ID=" + Doctor_ID + ", Doctor_Name=" + Doctor_Name + ", Address=" + Address + ", Specialized_IN=" + Specialized_IN + ", Salary=" + Salary + '}';
    }
