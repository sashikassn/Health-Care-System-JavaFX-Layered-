...
public class PatientDTO {
    ...
    public PatientDTO(String Patient_ID, String Patient_NAME, int Patient_AGE, String Patient_Gender, String Patient_Address) {
    ...
    public String toString() {
        return "PatientDTO{" + "Patient_ID=" + getPatient_ID() + ", Patient_NAME=" + getPatient_NAME() + ", Patient_AGE=" + getPatient_AGE() + ", Patient_Gender=" + getPatient_Gender() + ", Patient_Address=" + getPatient_Address() + '}';
    }
