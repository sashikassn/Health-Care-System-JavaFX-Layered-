...
public class DoctorDTO {
    ...
    public DoctorDTO(String Doctor_ID, String Doctor_Name, String Address, String Specialized_IN, Double Salary) {
    ...
    public String toString() {
        return "DoctorDTO{" + "Doctor_ID=" + getDoctor_ID() + ", Doctor_Name=" + getDoctor_Name() + ", Address=" + getAddress() + ", Specialized_IN=" + getSpecialized_IN() + ", Salary=" + getSalary() + '}';
    }
